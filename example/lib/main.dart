...
class _EncryptionDemoState extends State<EncryptionDemo> {
  ...
  Future<void> _encryptAES() async {
    ...
    try {
      ...
      final encrypted = await _encryptionManager.encryptAES(_plaintextController.text);
  ...
  Future<void> _encryptRSA() async {
    ...
    try {
      ...
      final encrypted = await _encryptionManager.encryptRSAInBlocks(_plaintextController.text);
  ...
  Future<void> _decryptRSA() async {
    ...
    try {
      ...
      final decrypted = await _encryptionManager.decryptRSAInBlocks(_encryptedText);
          ...
          children: [
            ...
            Row(
              children: [
                Expanded(
                  child: ElevatedButton.icon(
                    onPressed: _isInitialized && _encryptedText.isNotEmpty ? _decryptAES : null,
                ...
                Expanded(
                  child: ElevatedButton.icon(
                    onPressed: _isInitialized && _encryptedText.isNotEmpty ? _decryptRSA : null,
